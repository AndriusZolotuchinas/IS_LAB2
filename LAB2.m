...
for indx=1:10000
    for n = 1:26
        ...
        %------------------------------------------------------------------
        e1 = y(n) - y1_apskaiciuota;

        %------------------------------------------------------------------
        %formule w = w + mok zingsnis*delta*input
        delta_out_1 = e1;
        ...
        b1_1 = b1_1 + mok_zing*delta_1_1*1;
        b2_1 = b2_1 + mok_zing*delta_2_1*1;
        b3_1 = b3_1 + mok_zing*delta_3_1*1;
        b4_1 = b4_1 + mok_zing*delta_4_1*1;
        b5_1 = b5_1 + mok_zing*delta_5_1*1;
...
figure
plot(x,y,'kx',x,y1_apskaiciuota,'rx')
